...
create function public.location_geojson_bounds(p_geojson jsonb)
returns box
language sql
immutable
strict
...
alter table public.locations
  add column geojson_bounds box
  generated always as (public.location_geojson_bounds(geojson)) stored;

create index idx_locations_geojson_bounds
  on public.locations
  using gist (geojson_bounds);

create function public.get_locations_in_bounds(
